...
- **Stepping**: el notch del turnover és al **nucli** (offset), no a l'anell — el rotor
  del mig avança quan `(finestra_dret − anell_dret) mod 26 == notch_offset` (III: 22).
  Amb això, els missatges es llegeixen nets d'una sola clau.
